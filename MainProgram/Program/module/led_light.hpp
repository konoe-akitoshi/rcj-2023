...
constexpr module::LedLight SwitchLedR(pins::rp2040::GPIO14, LOW, HIGH);
constexpr module::LedLight SwitchLedG(pins::rp2040::GPIO15, LOW, HIGH);
constexpr module::LedLight LineSensorLed(pins::rp2040::GPIO22, HIGH, LOW);
