...
std::array<component::DigitalReader, 5> LineSensors = {
    component::DigitalReader(SetupHandler, PIN_LINE_SENSOR_D1, INPUT_PULLUP),
    component::DigitalReader(SetupHandler, PIN_LINE_SENSOR_D2, INPUT_PULLUP),
    component::DigitalReader(SetupHandler, PIN_LINE_SENSOR_D3, INPUT_PULLUP),
    component::DigitalReader(SetupHandler, PIN_LINE_SENSOR_D4, INPUT_PULLUP),
    component::DigitalReader(SetupHandler, PIN_LINE_SENSOR_D5, INPUT_PULLUP)
};
