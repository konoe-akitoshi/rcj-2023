...
#
sensor.set_auto_gain(False, gain_db = 15) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (63.00, 60.21, 63.62) ) # must be turned off for color tracking
...
# check Yellow Goal
    i_y = 0
    balls_y1 = img.find_blobs(obj_color_yellow, pixels_threshold=250, area_threshold=250)#元値500
...
# check Blue Goal
    i_b = 0
    balls_b1 = img.find_blobs(obj_color_blue, pixels_threshold=250, area_threshold=250)
