...
obj_color_orange =   [(14, 100, 22, 127, 127, 22)]      # Orange Ball
obj_color_yellow =   [(0, 82, 29, -20, 26, 127)]      # Yellow Goal
obj_color_blue   =   [(20, 100, 20, -30, -25, -128)]     # Blue Goal
...
#
sensor.set_auto_gain(False, gain_db = 13.53) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (61, 60.21, 66.27) ) # must be turned off for color tracking
...
# check Yellow Goal
    i_y = 0
    balls_y1 = img.find_blobs(obj_color_yellow, pixels_threshold=500, area_threshold=500)#元値500
...
# check Blue Goal
    i_b = 0
    balls_b1 = img.find_blobs(obj_color_blue, pixels_threshold=500, area_threshold=500)
