...
obj_color_orange =   [(47, 60,   59, 127, 127, 20)]      # Orange Ball
obj_color_yellow =   [(0, 87, -40, 6, 28, 127)]      # Yellow Goal
...
#
sensor.set_auto_gain(False, gain_db = 5) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (-10, -7, -2) ) # must be turned off for color tracking
