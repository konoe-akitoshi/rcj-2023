...
obj_color_orange =   [(16, 80, 1, 32, 16, 56)]      # Orange Ball
obj_color_yellow =   [(47, 67, -20, -5, 33, 127)]      # Yellow Goal
obj_color_blue   =   [(14, 26, -17, 6, -30, -6)]     # Blue Goal
...
sensor.set_auto_whitebal(False, rgb_gain_db = (63.73, 60.21, 64.26)) # must be turned off for color tracking
clock = time.clock()
