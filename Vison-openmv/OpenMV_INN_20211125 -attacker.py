...
sensor.set_auto_gain(False, gain_db = 100) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (60.21, 61.02, 67.43)) # must be turned off for color tracking
clock = time.clock()
