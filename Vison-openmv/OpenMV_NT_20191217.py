...
obj_color_orange =   [(30, 70, 35, 127, 127, 20)]      # Orange Ball
obj_color_yellow =   [(12, 100, -15, 9, 14, 99)]      # Yellow Goal
...
#
sensor.set_auto_gain(False, gain_db = 4 ) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (-8, -7, -3) ) # must be turned off for color tracking
